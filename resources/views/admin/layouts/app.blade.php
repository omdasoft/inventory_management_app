...
<body>
    ...
    <div class="main-wrapper" id="app">
                    ...
                    <div class="dropdown-menu menu-drop-user">
                        <div class="profilename">
                            ...
                            <form method="post" action="{{ route('logout') }}">
                                @csrf
                                <a class="dropdown-item logout pb-0" href="#" onclick="event.preventDefault(); this.closest('form').submit()"><img
                                    src="{{ asset('img/icons/log-out.svg') }}" class="me-2" alt="img">Logout</a>
                            </form>
                        </div>
                    </div>
                </li>
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                ><img
                                    src="{{ asset('img/icons/product.svg') }}" alt="img"><span>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                class=""><img
                                    src="{{ asset('img/icons/purchase1.svg') }}" alt="img"><span>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                class=""><img
                                    src="{{ asset('img/icons/expense1.svg') }}" alt="img"><span>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                class="">
                                <i data-feather="box"></i> <span>Store</span> <span class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="#" wire:navigate
                                        class="">Store
                                        List</a></li>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                class=""><img
                                    src="{{ asset('img/icons/time.svg') }}" alt="img"><span>
                       ...
                       <li class="submenu">
                            <a href="javascript:void(0);"
                                class=""><img
                                    src="{{ asset('img/icons/users1.svg') }}" alt="img"><span>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                class=""><img
                                    src="{{ asset('img/icons/settings.svg') }}" alt="img"><span>
        ...
        <div class="page-wrapper">
            <!-- @if(!auth()->user()->token) 
                <a href="{{ route('oauth.redirect') }}">Get new token</a>
            @endif -->
            <div class="content">
